...
public class InternalDelegationParser extends AbstractInternalAntlrParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_ID", "RULE_STRING", "RULE_INT", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'delegation'", "'from'", "'to'", "','", "'{'", "'query'", "'select'", "'}'", "'import'", "'user'", "'group'", "'policy'", "'by'", "'default'", "'with'", "'resolution'", "'rule'", "'priority'", "'obj'", "'('", "')'", "'ref'", "'->'", "':'", "'attr'", "'where'", "'is'", "'bound'", "'::'", "'deny'", "'obfuscate'", "'allow'", "'unset'", "'R'", "'W'", "'RW'", "'restrictive'", "'permissive'"
    };
    ...
    // InternalDelegation.g:1162:1: ruleBind returns [EObject current=null] : ( ( (lv_valueString_0_0= RULE_STRING ) ) | ( (lv_valueInteger_1_0= RULE_INT ) ) | ( (lv_valueEnumLiteral_2_0= ruleEnumValue ) ) ) ;
    public final EObject ruleBind() throws RecognitionException {
        EObject current = null;

        Token lv_valueString_0_0=null;
        Token lv_valueInteger_1_0=null;
        EObject lv_valueEnumLiteral_2_0 = null;
        ...
        try {
            // InternalDelegation.g:1168:2: ( ( ( (lv_valueString_0_0= RULE_STRING ) ) | ( (lv_valueInteger_1_0= RULE_INT ) ) | ( (lv_valueEnumLiteral_2_0= ruleEnumValue ) ) ) )
            // InternalDelegation.g:1169:2: ( ( (lv_valueString_0_0= RULE_STRING ) ) | ( (lv_valueInteger_1_0= RULE_INT ) ) | ( (lv_valueEnumLiteral_2_0= ruleEnumValue ) ) )
            {
            // InternalDelegation.g:1169:2: ( ( (lv_valueString_0_0= RULE_STRING ) ) | ( (lv_valueInteger_1_0= RULE_INT ) ) | ( (lv_valueEnumLiteral_2_0= ruleEnumValue ) ) )
            int alt13=3;
            switch ( input.LA(1) ) {
            ...
            switch (alt13) {
                ...
                case 2 :
                    ...
                    break;
                case 3 :
                    // InternalDelegation.g:1208:3: ( (lv_valueEnumLiteral_2_0= ruleEnumValue ) )
                    {
                    // InternalDelegation.g:1208:3: ( (lv_valueEnumLiteral_2_0= ruleEnumValue ) )
                    // InternalDelegation.g:1209:4: (lv_valueEnumLiteral_2_0= ruleEnumValue )
                    {
                    // InternalDelegation.g:1209:4: (lv_valueEnumLiteral_2_0= ruleEnumValue )
                    // InternalDelegation.g:1210:5: lv_valueEnumLiteral_2_0= ruleEnumValue
                    {

                    					newCompositeNode(grammarAccess.getBindAccess().getValueEnumLiteralEnumValueParserRuleCall_2_0());
                    				
                    pushFollow(FOLLOW_2);
                    lv_valueEnumLiteral_2_0=ruleEnumValue();
                    ...
                    state._fsp--;
                    					...
                    					set(
                    						current,
                    						"valueEnumLiteral",
                    						lv_valueEnumLiteral_2_0,
                    						"org.mondo.collaboration.policy.Rules.EnumValue");
                    					afterParserOrEnumRuleCall();
    ...
    // InternalDelegation.g:1231:1: entryRuleEnumValue returns [EObject current=null] : iv_ruleEnumValue= ruleEnumValue EOF ;
    public final EObject entryRuleEnumValue() throws RecognitionException {
        ...
        try {
            // InternalDelegation.g:1231:50: (iv_ruleEnumValue= ruleEnumValue EOF )
            // InternalDelegation.g:1232:2: iv_ruleEnumValue= ruleEnumValue EOF
            {
    ...
    // InternalDelegation.g:1238:1: ruleEnumValue returns [EObject current=null] : (otherlv_0= '::' ( (otherlv_1= RULE_ID ) ) ) ;
    public final EObject ruleEnumValue() throws RecognitionException {
        ...
        try {
            // InternalDelegation.g:1244:2: ( (otherlv_0= '::' ( (otherlv_1= RULE_ID ) ) ) )
            // InternalDelegation.g:1245:2: (otherlv_0= '::' ( (otherlv_1= RULE_ID ) ) )
            {
            // InternalDelegation.g:1245:2: (otherlv_0= '::' ( (otherlv_1= RULE_ID ) ) )
            // InternalDelegation.g:1246:3: otherlv_0= '::' ( (otherlv_1= RULE_ID ) )
            {
            otherlv_0=(Token)match(input,39,FOLLOW_4); 

            			newLeafNode(otherlv_0, grammarAccess.getEnumValueAccess().getColonColonKeyword_0());
            		
            // InternalDelegation.g:1250:3: ( (otherlv_1= RULE_ID ) )
            // InternalDelegation.g:1251:4: (otherlv_1= RULE_ID )
            {
            // InternalDelegation.g:1251:4: (otherlv_1= RULE_ID )
            // InternalDelegation.g:1252:5: otherlv_1= RULE_ID
            {
            ...
            otherlv_1=(Token)match(input,RULE_ID,FOLLOW_2); 
            					...
            					newLeafNode(otherlv_1, grammarAccess.getEnumValueAccess().getLiteralEEnumLiteralCrossReference_1_0());
    ...
    // InternalDelegation.g:1267:1: ruleAccessibilityLevel returns [Enumerator current=null] : ( (enumLiteral_0= 'deny' ) | (enumLiteral_1= 'obfuscate' ) | (enumLiteral_2= 'allow' ) ) ;
    public final Enumerator ruleAccessibilityLevel() throws RecognitionException {
        ...
        try {
            // InternalDelegation.g:1273:2: ( ( (enumLiteral_0= 'deny' ) | (enumLiteral_1= 'obfuscate' ) | (enumLiteral_2= 'allow' ) ) )
            // InternalDelegation.g:1274:2: ( (enumLiteral_0= 'deny' ) | (enumLiteral_1= 'obfuscate' ) | (enumLiteral_2= 'allow' ) )
            {
            // InternalDelegation.g:1274:2: ( (enumLiteral_0= 'deny' ) | (enumLiteral_1= 'obfuscate' ) | (enumLiteral_2= 'allow' ) )
            int alt14=3;
            switch ( input.LA(1) ) {
            ...
            switch (alt14) {
                case 1 :
                    // InternalDelegation.g:1275:3: (enumLiteral_0= 'deny' )
                    {
                    // InternalDelegation.g:1275:3: (enumLiteral_0= 'deny' )
                    // InternalDelegation.g:1276:4: enumLiteral_0= 'deny'
                    {
                    enumLiteral_0=(Token)match(input,40,FOLLOW_2); 

                    				current = grammarAccess.getAccessibilityLevelAccess().getDENYEnumLiteralDeclaration_0().getEnumLiteral().getInstance();
                    				newLeafNode(enumLiteral_0, grammarAccess.getAccessibilityLevelAccess().getDENYEnumLiteralDeclaration_0());
                    ...
                    break;
                case 2 :
                    // InternalDelegation.g:1283:3: (enumLiteral_1= 'obfuscate' )
                    {
                    // InternalDelegation.g:1283:3: (enumLiteral_1= 'obfuscate' )
                    // InternalDelegation.g:1284:4: enumLiteral_1= 'obfuscate'
                    {
                    ...
                    break;
                case 3 :
                    // InternalDelegation.g:1291:3: (enumLiteral_2= 'allow' )
                    {
                    // InternalDelegation.g:1291:3: (enumLiteral_2= 'allow' )
                    // InternalDelegation.g:1292:4: enumLiteral_2= 'allow'
                    {
                    enumLiteral_2=(Token)match(input,42,FOLLOW_2); 

                    				current = grammarAccess.getAccessibilityLevelAccess().getALLOWEnumLiteralDeclaration_2().getEnumLiteral().getInstance();
                    				newLeafNode(enumLiteral_2, grammarAccess.getAccessibilityLevelAccess().getALLOWEnumLiteralDeclaration_2());
    ...
    // InternalDelegation.g:1302:1: ruleOperationType returns [Enumerator current=null] : ( (enumLiteral_0= 'unset' ) | (enumLiteral_1= 'R' ) | (enumLiteral_2= 'W' ) | (enumLiteral_3= 'RW' ) ) ;
    public final Enumerator ruleOperationType() throws RecognitionException {
        ...
        try {
            // InternalDelegation.g:1308:2: ( ( (enumLiteral_0= 'unset' ) | (enumLiteral_1= 'R' ) | (enumLiteral_2= 'W' ) | (enumLiteral_3= 'RW' ) ) )
            // InternalDelegation.g:1309:2: ( (enumLiteral_0= 'unset' ) | (enumLiteral_1= 'R' ) | (enumLiteral_2= 'W' ) | (enumLiteral_3= 'RW' ) )
            {
            // InternalDelegation.g:1309:2: ( (enumLiteral_0= 'unset' ) | (enumLiteral_1= 'R' ) | (enumLiteral_2= 'W' ) | (enumLiteral_3= 'RW' ) )
            int alt15=4;
            switch ( input.LA(1) ) {
            ...
            switch (alt15) {
                case 1 :
                    // InternalDelegation.g:1310:3: (enumLiteral_0= 'unset' )
                    {
                    // InternalDelegation.g:1310:3: (enumLiteral_0= 'unset' )
                    // InternalDelegation.g:1311:4: enumLiteral_0= 'unset'
                    {
                    ...
                    break;
                case 2 :
                    // InternalDelegation.g:1318:3: (enumLiteral_1= 'R' )
                    {
                    // InternalDelegation.g:1318:3: (enumLiteral_1= 'R' )
                    // InternalDelegation.g:1319:4: enumLiteral_1= 'R'
                    {
                    ...
                    break;
                case 3 :
                    // InternalDelegation.g:1326:3: (enumLiteral_2= 'W' )
                    {
                    // InternalDelegation.g:1326:3: (enumLiteral_2= 'W' )
                    // InternalDelegation.g:1327:4: enumLiteral_2= 'W'
                    {
                    ...
                    break;
                case 4 :
                    // InternalDelegation.g:1334:3: (enumLiteral_3= 'RW' )
                    {
                    // InternalDelegation.g:1334:3: (enumLiteral_3= 'RW' )
                    // InternalDelegation.g:1335:4: enumLiteral_3= 'RW'
                    {
    ...
    // InternalDelegation.g:1345:1: ruleResolutionType returns [Enumerator current=null] : ( (enumLiteral_0= 'restrictive' ) | (enumLiteral_1= 'permissive' ) ) ;
    public final Enumerator ruleResolutionType() throws RecognitionException {
        ...
        try {
            // InternalDelegation.g:1351:2: ( ( (enumLiteral_0= 'restrictive' ) | (enumLiteral_1= 'permissive' ) ) )
            // InternalDelegation.g:1352:2: ( (enumLiteral_0= 'restrictive' ) | (enumLiteral_1= 'permissive' ) )
            {
            // InternalDelegation.g:1352:2: ( (enumLiteral_0= 'restrictive' ) | (enumLiteral_1= 'permissive' ) )
            int alt16=2;
            ...
            switch (alt16) {
                case 1 :
                    // InternalDelegation.g:1353:3: (enumLiteral_0= 'restrictive' )
                    {
                    // InternalDelegation.g:1353:3: (enumLiteral_0= 'restrictive' )
                    // InternalDelegation.g:1354:4: enumLiteral_0= 'restrictive'
                    {
                    ...
                    break;
                case 2 :
                    // InternalDelegation.g:1361:3: (enumLiteral_1= 'permissive' )
                    {
                    // InternalDelegation.g:1361:3: (enumLiteral_1= 'permissive' )
                    // InternalDelegation.g:1362:4: enumLiteral_1= 'permissive'
                    {
    ...
    public static final BitSet FOLLOW_6 = new BitSet(new long[]{0x0000070000000000L});
    public static final BitSet FOLLOW_7 = new BitSet(new long[]{0x0000780000002000L});
    ...
    public static final BitSet FOLLOW_32 = new BitSet(new long[]{0x0000008000000060L});
